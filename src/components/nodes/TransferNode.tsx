...
export function TransferNode({ data }: { data: FlowNodeData }) {
  ...
  return (
    <div className="bg-white border border-rose-200 rounded-xl shadow-sm w-[240px] overflow-hidden">
      ...
      <div className="px-3 pb-2 pt-1">
        <span className="inline-flex items-center gap-1 text-[10px] bg-rose-50 text-rose-700 border border-rose-200 rounded-full px-2 py-0.5">
