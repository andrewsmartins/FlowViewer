...
import { CREATABLE_KIND_LABELS as KIND_LABELS, CREATABLE_KINDS } from '../utils/nodeCatalog'
...
/** Paleta de criação de nós: arraste um tipo para o canvas para criar uma intenção nova. */
